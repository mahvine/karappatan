...
import { CaseSummaryComponent } from 'app/entities/case-summary/case-summary.component';
...
describe('Component Tests', () => {
    describe('CaseSummary Management Component', () => {
        let comp: CaseSummaryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CaseSummaryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.caseSummaries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
