...
import { KarappatanCoreModule } from 'app/core';
import { KarappatanAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        ...
        KarappatanSharedModule.forRoot(),
...
export class KarappatanAppModule {
